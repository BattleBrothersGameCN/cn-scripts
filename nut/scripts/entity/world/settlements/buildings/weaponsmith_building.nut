this.weaponsmith_building <- this.inherit("scripts/entity/world/settlements/buildings/building", {
	...
	function onUpdateShopList()
	{
		...
		{
			if (this.m.Settlement.getTile().SquareCoords.Y > this.World.getMapSize().Y * 0.700000)
			{
				list.push({
					R = 70,
					P = 1.000000,
			...
			else if (this.m.Settlement.getTile().SquareCoords.Y < this.World.getMapSize().Y * 0.400000)
			{
				list.push({
					R = 75,
					P = 1.000000,
		...
		this.fillStash(list, this.m.Stash, 1.250000, false);
	}
