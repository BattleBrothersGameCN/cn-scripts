	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Cocky.worsenMood(1.000000, "在战团面前丢脸");
				this.List.push({
					id = 10,
				...
				_event.m.IronLungs.improveMood(1.000000, "击败 (Beat)" + _event.m.Cocky.getName() + "在力量比拼中");
				this.List.push({
					id = 10,
				...
				foreach( bro in brothers )
				{
					...
					{
						bro.improveMood(0.500000, "感到愉快来自 " + _event.m.Cocky.getNameOnly());
