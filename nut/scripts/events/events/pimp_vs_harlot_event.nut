	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Dude.getBackground().m.RawDescription = "在你访问" + _event.m.Town.getName() + "期间，你发现 %name% 正在和他唯一的妓女争吵。" + _event.m.Monk.getName() + "说服他加入了战团，你同意带他一起走。希望他在盾墙里战斗的本领高过和妓女吵架的。";
