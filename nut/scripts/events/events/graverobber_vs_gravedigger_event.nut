	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Graverobber.worsenMood(0.500000, "发生斗殴和 " + _event.m.Gravedigger.getName());
				this.List.push({
					id = 10,
				...
				_event.m.Gravedigger.worsenMood(0.500000, "发生斗殴和 " + _event.m.Graverobber.getName());
				this.List.push({
					id = 10,
