this.apprentice_learns_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "D",
			Text = "[img]gfx/ui/events/event_05.png[/img]你曾多次看到，%apprentice%远远地望着%teacher%。年轻的学徒似乎为流浪骑士的暴力美学所折服。几天后，骑士松口了，让小伙子过来和他聊聊。你不知道他们说了什么，但他们已经在一起训练。 流浪骑士可不是个慈祥的教官，他经常暴打那个男孩，让他坚强起来。起初，每次训练前，学徒都会退缩，但现在，面对如此巨大的逆境，他表现出了更强的决心。流浪骑士也传授了快速有效杀人的技巧。在你无意听到的谈话中，防御方面的内容很少被提及，不过谁需要防御一个死掉的对手呢？",
			Image = "",
			List = [],
			Characters = [],
			Options = [
