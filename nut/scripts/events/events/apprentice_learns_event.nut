this.apprentice_learns_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "B",
			Text = "[img]gfx/ui/events/event_05.png[/img]重操旧业的退役士兵%teacher%垂青于%apprentice%，他俩一有机会就在练习武艺。 老战士深信攻击就是最好的防御，教授学徒使用各类武器时伤害最大化的方法。美中不足的是，糟心的是他们居然拿着战团的锅碗瓢盆摆弄成小人偶来练手。那小子为了变厉害，可把这些吃饭家伙砸得够呛。",
			Image = "",
			List = [],
			Characters = [],
			Options = [
		...
		this.m.Screens.push({
			ID = "C",
			Text = "[img]gfx/ui/events/event_05.png[/img]年轻的%apprentice%成了老佣兵%teacher%的小跟班。既然进了佣兵这行，学徒肯定想跟这些拿刀口舔血的老手学几招。看他们训练时，你发现老佣兵最看重的是练好身板。比对手出手更快、更能扛，跟一刀捅穿人脑壳一样重要。这认真的小伙子现在看着结实多了，浑身有股以前没见过的活力。",
			Image = "",
			List = [],
			Characters = [],
			Options = [
		...
		this.m.Screens.push({
			ID = "D",
			Text = "[img]gfx/ui/events/event_05.png[/img]你几回都撞见%apprentice%远远地望着%teacher%。年轻的学徒似乎为流浪骑士的暴力美学所折服。几天后，骑士松口了，让小伙子过来和他聊聊。你不知道他们说了什么，但他们已经在一起训练。 流浪骑士可不是个慈祥的教官，他经常暴打那个男孩，让他坚强起来。起初，每次训练前，学徒每次接招都会缩脖子，现在倒能在暴风雨般的捶打中多撑住几分了。流浪骑士也传授了快速有效杀人的技巧。在你无意听到的谈话中，防御方面的内容很少被提及，不过谁需要防御一个死掉的对手呢？",
			Image = "",
			List = [],
			Characters = [],
			Options = [
