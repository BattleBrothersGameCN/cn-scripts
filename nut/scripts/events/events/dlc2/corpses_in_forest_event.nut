this.corpses_in_forest_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "D",
			Text = "[img]gfx/ui/events/event_132.png[/img]{[%beastslayer%举起他的手。%SPEECH_ON%他们不是被谋杀的，他们被清除了。%SPEECH_OFF%他蹲在堆积物的边缘旁，摆弄着一个被烧焦的手臂，并在肘部处用力扭动。他把手臂翻过来，然后用力挤压。青色汁液从静脉应该存在的地方渗出，滴落到地上。这位兽人猎手拿起一个小瓶子，收集了他能收集到的内容。%SPEECH_ON%这些人被蛛魔的毒素感染了。这种毒素通常会溶解器官并致死，但有时候却会有其他效果。会在手臂生长出厚实的毛发，指甲变长，肩胛骨开始疼痛并凸出背部。不好看。而中毒者则会发疯。%SPEECH_OFF%你问这些人是否都中毒了。兽人猎手摇了摇头。%SPEECH_ON%我从这个肩膀认识他，其余的，我不知道。当一种疾病笼罩着一个村庄时，整个村庄都会被笼罩在其中，很快混乱和困惑就会成为感染的传播，而疾病本身只是在自己引发的篝火中漂泊的一道被遗忘的火花。%SPEECH_OFF%}",
			Image = "",
			List = [],
			Characters = [],
			Options = [
