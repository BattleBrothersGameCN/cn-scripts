		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				this.List.push({
					id = 16,
					icon = "ui/icons/fatigue.png",
					text = _event.m.Strong2.getName() + " 获得了 [color=" + this.Const.UI.Color.PositiveEventValue + "]+1[/color] 最大疲劳值"
				});
				_event.m.Strong1.improveMood(1.000000, "建立友谊与 " + _event.m.Strong2.getName());
				this.List.push({
					id = 10,
				...
				_event.m.Strong2.improveMood(1.000000, "建立友谊与 " + _event.m.Strong1.getName());
				this.List.push({
					id = 10,
