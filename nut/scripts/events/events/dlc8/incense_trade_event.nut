this.incense_trade_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "B",
			Text = "[img]gfx/ui/events/event_143.png[/img]{你告诉他他可以闻他想要的，只要最后付钱给你就可以了。他同意了，走到你的车旁，长长的风筝在头顶上飘荡着，像是永恒的秃鹫，在白雪的迷雾中掠过。他俯身探进车厢，每次呼吸都会令他的鼻子冒出冷气。他找到了香炉，并露出了微笑。%SPEECH_ON%啊，是啊，我已经很多年没有闻到这么好的香气了。%SPEECH_OFF%他把夹在手臂中的香炉交给了你，随后掏出一个大钱袋子放在了车尾。你数了数里面的钱，比在任何地方出售这些香料都要多得多。他转向你，握着香炉。%SPEECH_ON%公平的交易吧？%SPEECH_OFF%}",
			Image = "",
			List = [],
			Characters = [],
			Options = [
		...
		this.m.Screens.push({
			ID = "E",
			Text = "[img]gfx/ui/events/event_143.png[/img]{你让那个人让开，否则...他照着指示做了，尽管他两手着地，手指空无一物地在嗅到的气味上寻找。你回头看了几眼，确保他没有跟踪。他站在白雪覆盖的荒野上，凝视着你的马车。然后他只是一道黑影，消失了，他的风筝在你认为他所在的地方翩翩起舞，最后也消失了。}",
			Image = "",
			List = [],
			Characters = [],
			Options = [
