this.peacenik_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "B",
			Text = "[img]gfx/ui/events/event_40.png[/img]驯犬师%houndmaster%点头，解释说，不管一只动物多么聪明或训练有素，它仍然是一只动物。 和平主义者想了一会儿。%SPEECH_ON%呃－不过，它不仅仅是一只狗！%SPEECH_OFF%你的驯犬师抓住那人的肩膀。%SPEECH_ON%但是你已经把它逼得走投无路了，不是吗？ 你认为一个拥有智慧的人在这种情况下会做什么，他的背后是墙而敌人就在眼前？ 现在不是交“和平”朋友的时候，无论是与人类还是野兽。%SPEECH_OFF%陌生人慢慢地开始点头。 他看到了争论的意义，谢天谢地，没有再阻碍你解决掉兽人。 解决掉兽人以后，那人给了你一袋克朗。%SPEECH_ON%我想试着用这些克朗来保值增值。 如果你没有出现，我现在可能已经死了，很明显，现在不会发生这种事了。 把这当作我的谢意，佣兵。%SPEECH_OFF%",
			Image = "",
			List = [],
			Characters = [],
			Options = [
