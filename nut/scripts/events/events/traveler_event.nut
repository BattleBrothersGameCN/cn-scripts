this.traveler_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "D1",
			Text = "[img]gfx/ui/events/event_26.png[/img]你坐在火旁。 关于这个或那个的谈论很多，但旅行者说的一些话在他离开后很长一段时间仍留在你的脑海里。%SPEECH_ON%感谢你们提供的鱼，先生们，但是我不得不拒绝。请听我解释。 那天我正在挖坑准备像传统那样埋葬我的兄弟。 有个远方表亲就在我旁边。 他就住我隔壁，事实上确实如此。 这家伙死于疾病，某种我完全不知道的疾病，但除了他谁也没有感染这疾病我猜我们都逃过一劫。 他死的时候还是那么年轻。 你们知道那是个什么疾病吗？%SPEECH_OFF%",
			Image = "",
			List = [],
			Options = [
				{
		...
		this.m.Screens.push({
			ID = "F1",
			Text = "[img]gfx/ui/events/event_26.png[/img]你们坐在火堆旁，东拉西扯的谈了很多，但确实有这样一些话，即便旅行者走后依然在你的脑海里挥之不去。%SPEECH_ON%十年前，我参加了万名之战，兽人与人类的决战，后来成了那个时代的代名词。我当时是骑兵的一员，被部署在战场的南翼，那里除了泥潭就是沼泽，根本不适合骑兵作战，但我们的指挥官才不管那些，坚持让我们推进。兽人的长枪直接刺穿了他的马，连他一起扎了个透心凉。把骑兵带到那种烂泥地里……真是糟糕透了。我听说北翼的情况稍好一些，不过这已无关紧要——谁也没能赢下那场该死的战斗。%SPEECH_OFF%",
			Image = "",
			List = [],
			Options = [
				{
		...
		this.m.Screens.push({
			ID = "H1",
			Text = "[img]gfx/ui/events/event_26.png[/img]你们坐在火堆旁，东拉西扯的谈了很多，但确实有这样一些话，即便旅行者走后依然在你的脑海里挥之不去。%SPEECH_ON%啊，万名之战啊。嗯，我参加了。先锋队。中央前线。不，我可不想再提起它了。%SPEECH_OFF%",
			Image = "",
			List = [],
			Options = [
				{
		...
		this.m.Screens.push({
			ID = "I2",
			Text = "[img]gfx/ui/events/event_26.png[/img] 旅行者停了下来，眼睛盯着篝火。 他用手杖探了探边缘。%SPEECH_ON%那大概是聊起战争这个话题我最不愿回忆的一个情景。 我终于醒来，雨已经到了我的鼻子了。 我昏迷中差点被淹死。 我从马的尸体下艰难地爬出来爬了鬼知道多久。 兽人和人类到处都是，死透的，快要死的，快被淹死的。 惨叫呻吟。不知道是谁发出来的。 我还记得那些泥浆。 我还记得我深陷其中。 一位女士，她的手臂比牛还强壮，她拯救了我。 她把我扔进一辆货车而我最后看见的是战场。啊对不起。 我必须停止这个话题。谢谢你让我和你们一起过夜。%SPEECH_OFF%",
			Image = "",
			List = [],
			Options = [
				{
		...
		this.m.Screens.push({
			ID = "J1",
			Text = "[img]gfx/ui/events/event_26.png[/img]你们坐在火堆旁，东拉西扯的谈了很多，但确实有这样一些话，即便旅行者走后依然在你的脑海里挥之不去。%SPEECH_ON%我带领一支战团参加了万名之战。这可是正义的事业。人类对兽人！哇，多么壮观。我的人有一半都死在了战场上，但是他们的牺牲拯救了整个大陆！我深情的感慨那些时光。谁又不是呢？%SPEECH_OFF%",
			Image = "",
			List = [],
			Options = [
				{
