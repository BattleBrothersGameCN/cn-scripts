this.oath_of_distinction_ambition <- this.inherit("scripts/ambitions/oaths/oath_ambition", {
	...
	function create()
	{
		...
		this.m.SuccessText = "[img]gfx/ui/events/event_180.png[/img]{许多剑术大师都行独处之道。他们在战斗时并不直接着眼于结果对手，而是争夺对中间空间的控制。或许你并不理解剑术大师和佣兵挥剑时的个中差别，但是其中的核心理念不言自明。宣誓者，固然追求荣誉，勤勤恳恳，却执于蛮勇，刚愎自用。独身誓言是剑术大师技艺的灵魂，所有宣誓者都应当铭记于心。对任何人都是一样，只有独立证明过自己，面对别人的称赞才能问心无愧。以后要是碰巧有普通信徒看到我们，只要他没有什么偏见，他就绝对不能否认，%companyname%是一支身手不凡的队伍。\n\n但还是让什么独身见鬼去吧。我们不能因为过去的荣耀就洋洋得意！让我们立下新的誓言！}";
		this.m.SuccessButtonText = "{为了小安瑟姆！ | 执誓者万岁！ | 给渡誓者以死亡！}";
		this.m.OathName = "独身誓言";
