this.taxidermist_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "没什么能比冻土野兽的战利品更让人尊敬。\n让我们去猎一些来，给剥制师们找点活干！";
		this.m.UIText = "在剥制师那里制作物品";
		this.m.TooltipText = "拥有至少12件剥制成品。剥制师主要分布在被沼泽和森林附近的定居点，他们能把野兽掉落的东西，比如恐狼掉落的巨大狼皮，制成有用的物品。";
		...
		this.m.SuccessButtonText = "%companyname%自豪地展示着他们的战利品。";
	}
