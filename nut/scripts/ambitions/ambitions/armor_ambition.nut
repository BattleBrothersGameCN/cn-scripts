this.armor_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.SuccessText = "[img]gfx/ui/events/event_35.png[/img]获得更多的重型铠甲和头盔令%companyname%精神振奋。%SPEECH_ON%感觉到了吗？这就叫手艺。%SPEECH_OFF%%randombrother%一边说着，一边用硬木剑柄敲了敲同伴新戴上的头盔。%SPEECH_ON%想想以前因为那身破铜烂铁，咱们错过了多少油水厚的合同。%SPEECH_OFF%从今往后，后排的弟兄们作战时能更安心了——他们知道会有重甲的兄弟扛住正面猛攻。即便前排倒下，那身笨重装备至少能拖延敌人，为轻装的同伴争取撤退时间。";
