this.visit_settlements_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.SuccessText = "[img]gfx/ui/events/event_16.png[/img]你很快发现，并非所有人都像吟游诗人们传唱的那样，能保持住对旅行的热情。你决定让战团长长见识，但是这项决定却引起了不满，人们开始抱怨强行军和辗转夜路。不过并不是所有人都参与抱怨。%SPEECH_ON%如果一天的行军或一夜的雨水就能让你筋疲力尽，你如何面对兽人的攻击？%SPEECH_OFF%%sergeantbrother%问道，却被骂了回来。%SPEECH_ON%保持干燥，注意警戒。%SPEECH_OFF%你催促他们前进。每到一座村庄或城镇，你都会鼓励手下的人，让他们出出名，看起来他们确实听进去了，打架斗殴，在镇广场上喝得烂醉，恐吓商人，骚扰本地女孩。无论这些倒霉商人和农民怎么看待你的战团，至少他们一时半会是忘不了你了！探索了地图的边缘后，%companyname%的名字更广为人知，你对这片土地的了解也更深入了。";
