this.defeat_civilwar_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.SuccessText = "[img]gfx/ui/events/event_65.png[/img]在%winninghouse%的授意下，%companyname%与其他家族的武装军队对抗，这是一场艰苦卓绝的战斗。对手训练有素、纪律严明、装备精良，真是一场恶战，但最终你们战胜了%winninghouse%的敌人，为其赢得了胜利。\n\n在随后的庆功宴中，%randomnoble%，%winninghouse%的小贵族之一，提议你应该提前结束庆祝活动。你的人开始惹起了麻烦，他担心你们的人可能会辜负他家人的好客，偷走银制餐盘，与佣人斗殴。他还提到已经有窗户被打破了，并指向地板上的一些碎玻璃。\n\n你回答道，虽然%winninghouse%取得了胜利，但此时，其实力也较以往更为薄弱。要是现在疏远朋友……或是树立新敌，实在过于愚蠢。\n\n他将你的建议听了进去，庆祝活动一直持续到黎明。";
		this.m.SuccessButtonText = "不管他们是爱是恨，现在没人不知道%companyname%的名号！";
	}
