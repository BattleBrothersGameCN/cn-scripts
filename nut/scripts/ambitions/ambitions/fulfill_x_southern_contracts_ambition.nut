this.fulfill_x_southern_contracts_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.SuccessText = "[img]gfx/ui/events/event_150.png[/img]南方人追求知识，举止得体，但他们不会误解你雇佣兵的身份。在北方他们说你出卖武力，在这里他们说你追求克朗。你对这两种归因都不太在意，只认识到一个残酷的现实，尽管他们鄙视你，但他们还是会找到你，奖励你的能力，并在危机来临的时候想到你的买卖。\n\n这就是北方和南方共同的基石：克朗的力量。语言，宗教，民族，都见鬼去吧。一点金子不需要翻译，不需要调解，也不需要仲裁。你对克朗的追求表明你对南方人是可靠的，你的名声也像他们的口袋一样深。";
