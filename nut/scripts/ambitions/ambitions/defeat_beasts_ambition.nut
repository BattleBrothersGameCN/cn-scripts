this.defeat_beasts_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "野兽困扰着文明边缘的村庄。\n猎杀它们赚钱正是应有之义！";
		this.m.UIText = "击败游荡兽群";
		this.m.TooltipText = "在战斗中击败5群流浪野兽，如恐狼或食尸鬼，通过合同或自己寻找均可。";
		this.m.SuccessText = "[img]gfx/ui/events/event_56.png[/img]解决了又一群野兽后，你思考起了祖先的本性。你打量着自己，准备充分、全副武装，周游世界，不乏战争、战斗的经验，但野兽在世界上的危险丝毫不减。你的祖先，他们拥有什么？没有文明的庇护，没有城市照亮黑夜、点燃勇气，没有地图划出舒适的领地。然而…他们活了下来。是什么让他们做到的。怎么做到的？也许，在过去人类构成了威胁，野兽把人类作为怪物看待。又或者在我们的祖先之前，人们拥有过自己的城市，从远古时代起，全世界的动物和人类都处在动态平衡当中。如果是这样的话，那么你就不应该沉湎于过去，而是着眼于未来的岁月…";
