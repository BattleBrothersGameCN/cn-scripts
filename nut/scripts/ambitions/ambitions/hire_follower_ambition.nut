this.hire_follower_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "厨师、斥候这类人，可以在战场之\n外支援我们。我们要雇一个最合宜的！";
		this.m.UIText = "雇佣一名非战斗人员作为你的随从";
		this.m.TooltipText = "至少达到“初露锋芒”（250）名望，解锁第一个非战斗随从席位。你可以通过完成合同和赢得战斗来提高自己的名望。随后，在随从界面中雇佣一名非战斗随从。有些随从需要你先满足一些条件才能雇佣。";
