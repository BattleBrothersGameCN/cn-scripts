this.defeat_holywar_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "宗教动乱之火恐要吞噬这片土地。让我们的战团在热火中锻\n炼得比以往任何时候都强大，并通过赢得战争来赚取财富！";
		this.m.UIText = "结束南北战争";
		this.m.TooltipText = "选择北方贵族家族或南方城邦，与他们合作，赢得他们的圣战。每摧毁一支军队，每履行一份合同，都将加速战争的结束。";
