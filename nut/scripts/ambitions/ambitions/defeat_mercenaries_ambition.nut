this.defeat_mercenaries_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.SuccessText = "[img]gfx/ui/events/event_87.png[/img]%randombrother% 擦去额头上的汗水和血迹。%SPEECH_ON%这群抄袭的东西！ 那分明是我的独门招式！%SPEECH_OFF%雇佣兵是一群杂七杂八的群体，天生难以估计，装备千奇百怪，技能和经验参差不齐，战术诡计多端。 由于对于成员没有统一标准，他们可能只是一群寻求冒险的老商人。 但话说回来，你可能会被一群老兵惊讶到。 更糟糕的是，他们完全不讲究所谓的交战规则。 %defeatedcompany% 尽了最大努力，尽管他们知道许多与兄弟们相同的聪明策略，但他们还是敌不过 %companyname%。\n\n你的胜利肯定会让各地的雇主知道哪一个战团的锋刃最锋利。";
