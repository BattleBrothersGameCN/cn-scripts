this.alp_teleport_skill <- this.inherit("scripts/skills/skill", {
	...
	function onUse( _user, _targetTile )
	{
		...
		if (_user.getTile().IsVisibleForPlayer)
		{
			local effect = {
				...
				Stages = [
					{
						LifeTimeMin = 0.700000,
						LifeTimeMax = 0.700000,
						...
						VelocityMin = 80,
						VelocityMax = 100,
						DirectionMin = this.createVec(-1.000000, -1.000000),
	...
	{
		this.Tactical.getNavigator().teleport(_tag.User, _tag.TargetTile, _tag.OnDone, _tag, false, 0.000000);
	}
	...
	function onTeleportDone( _entity, _tag )
	{
		if (!_entity.isHiddenToPlayer())
		{
			local effect1 = {
				...
				Stages = [
					{
						LifeTimeMin = 0.400000,
						LifeTimeMax = 0.400000,
						ColorMin = this.createColor("ffffff5f"),
						ColorMax = this.createColor("ffffff5f"),
						ScaleMin = 1.000000,
						ScaleMax = 1.000000,
						...
						VelocityMin = 80,
						VelocityMax = 100,
						DirectionMin = this.createVec(0.000000, -1.000000),
						DirectionMax = this.createVec(0.000000, -1.000000),
				...
				Stages = [
					{
						...
						VelocityMin = 80,
						VelocityMax = 100,
						DirectionMin = this.createVec(1.000000, 0.000000),
						DirectionMax = this.createVec(1.000000, 0.000000),
