				...
				Stages = [
					{
						...
						VelocityMin = 60,
						VelocityMax = 100,
						DirectionMin = this.createVec(-0.700000, -0.600000),
						DirectionMax = this.createVec(-0.600000, -0.600000),
						SpawnOffsetMin = this.createVec(-35, -15),
						SpawnOffsetMax = this.createVec(35, 20)
					},
					{
						LifeTimeMin = 0.750000,
				...
				Stages = [
					{
						...
						VelocityMin = 60,
						VelocityMax = 100,
						DirectionMin = this.createVec(0.600000, -0.600000),
						DirectionMax = this.createVec(0.700000, -0.600000),
						SpawnOffsetMin = this.createVec(-35, -15),
						SpawnOffsetMax = this.createVec(35, 20)
					},
					{
						LifeTimeMin = 1.000000,
						LifeTimeMax = 1.250000,
						ColorMin = this.createColor("eeeeeeee"),
						ColorMax = this.createColor("ffffffff"),
						ScaleMin = 0.500000,
						ScaleMax = 0.750000,
