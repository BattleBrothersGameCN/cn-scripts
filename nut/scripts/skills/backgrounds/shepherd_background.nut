this.shepherd_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.BadEnding = "你认为一个牧羊人在雇佣军的队伍中会格格不入，而最终%name%也认同了这一点。他在你离开%companyname%不久后，他也离开了，据你最后听到的消息，他又回到了放羊的生活中。虽然大多数人在离开战团时情绪低落，但%name%受到的伤害并没有使他放弃安逸的生活方式 —— 盯着那群吓人程度不亚于噩梦的白绒绒小动物。";
