this.anatomist_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.GoodEnding = "所有你在%companyname%里认识的人中，解剖学家%name%也许是最难忘的一个。他不停的来信更是令你这么认为。你浏览了他最新的单向通讯：“队长！我已经成功地……”浏览中，浏览中，“……最伟大的发明！最……”浏览中，浏览中，“我将会出名！我的大脑会被研究，其重量……”没有什么意料之外的东西，不过你很高兴他仍然健康，尽管可能身体会比精神健康得多。";
