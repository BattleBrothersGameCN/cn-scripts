this.miller_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.BackgroundDescription = "碾磨工习惯于体力劳动。";
		this.m.GoodEnding = "%name%这个曾经的碾磨工在%companyname%待了一段时间，攒够了克朗开了自己的面包店。你最后听到的消息是他的剑形甜点在贵族中很受欢迎，他卖甜点赚的钱比他在战团赚的钱还多。";
		this.m.BadEnding = "随着%companyname%陷入困境，碾磨工%name%觉得赶紧走人是个不错的主意。他帮助一位贵族测试了一种利用骡子和水车联动磨粮的新方法。不幸的是，“帮忙”的结果是他掉进了装置里，被残酷地压死了。";
