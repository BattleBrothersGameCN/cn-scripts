this.flagellant_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.BadEnding = "随着战团迅速衰落，许多佣兵采取了孤注一掷的措施。自笞者%name%就是其中之一。由于混乱和困惑，一些人开始相信%name%可以引导他们获得荣誉和救赎。少数幸存者脱离了%companyname%，疯狂地加入了他的野蛮精神崇拜之中。在其旗手%name%的嚎叫声中，皈依者们无目的地漫步，半曲地躬身行走在大地上，背上覆盖着生皮。";
