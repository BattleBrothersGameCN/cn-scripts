this.dazed_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "这个角色受到了相当沉重的打击，感到头晕目眩，气喘吁吁。会在 [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] 回合后消退。";
	}
	...
	{
		return _user + "茫然了" + _victim + "，持续" + this.getEffectDurationString();
	}
