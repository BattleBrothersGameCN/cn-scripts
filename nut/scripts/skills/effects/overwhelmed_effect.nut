this.overwhelmed_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		_properties.MeleeSkillMult = this.Math.maxf(0.000000, _properties.MeleeSkillMult - 0.100000 * this.m.Count);
		_properties.RangedSkillMult = this.Math.maxf(0.000000, _properties.RangedSkillMult - 0.100000 * this.m.Count);
	}
