this.staggered_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "这个角色受到了相当沉重的打击，东倒西歪行动迟缓。剩余[color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] 回合。";
	}
	...
	{
		return _user + "趔趄了" + _victim + "，持续" + this.getEffectDurationString();
	}
