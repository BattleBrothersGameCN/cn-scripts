this.battle_standard_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "为了战团！";
		this.m.Description = "与战团光荣的战旗同在，这个角色蔑视危险向前推进的使命感溢于言表。";
	...
	function getBonus( _properties )
	{
		...
		if (bestBravery != 0)
		{
			bestBravery = this.Math.min(bestBravery * 0.100000, bestBravery - _properties.Bravery * _properties.BraveryMult);
		}
