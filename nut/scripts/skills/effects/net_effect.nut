this.net_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "陷在网中";
		this.m.Description = "一张大网将这个角色固定在了原地并阻碍了他自我保护的能力。只有割开网才能挣脱。";
	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-45%[/color]主动值"
			}
		];
	}
	...
	function onUpdate( _properties )
	{
		...
		_properties.MeleeDefenseMult *= 0.550000;
		_properties.RangedDefenseMult *= 0.550000;
		_properties.InitiativeMult *= 0.550000;
	}
