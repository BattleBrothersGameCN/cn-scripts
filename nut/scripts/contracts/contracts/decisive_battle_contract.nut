this.decisive_battle_contract <- this.inherit("scripts/contracts/contract", {
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			...
			Title = "在农场…",
			Text = "[img]gfx/ui/events/event_72.png[/img]{农舍就在附近。一片庄稼的海洋就在你们面前，随着风声荡漾。%randombrother% 把手伸向麦田。%randombrother2% 给了他的肩膀一拳。%SPEECH_ON%你想把害虫带回家吗？手拿开。%SPEECH_OFF%雇佣兵揉揉肩膀，打了回去.%SPEECH_ON%去你的，我爱把手伸到哪就伸到哪，问你妈。%SPEECH_OFF%拳击声此起彼伏，美好的场景被打破了。 | 农舍在远处。庄稼田随着风声轻轻摇曳，像平静的海浪一样。前头的农工们用大镰刀收割，后头的用叉子抬起残留的庄稼。驴子走在最后，拉着推车穿过崎岖的地形。 | 农场坐落在群山之间，这里的土壤很好，地形也影响不了农作物的生长。每一片田地都种满了庄稼，农工们闪闪发光的大镰刀和叉子在田间穿梭。你看到农场主们远远地站在一起。他们看起来很生气，但很少有人敢在%companyname%的面前发怒。}",
			Image = "",
			List = [],
			Options = [
				{
		...
		this.m.Screens.push({
			ID = "PoorFarmers",
			Title = "在农场…",
			Text = "[img]gfx/ui/events/event_60.png[/img]{农民和他们雇来的打手都被镇压了。其中一个农工，肠子外露，跪在地上，乞求宽恕。你摇了摇头。%SPEECH_ON%你已经没救了，孩子，剑才是你的救赎。%SPEECH_OFF%剑刃轻松地切过他的喉咙。鲜血流进气管咯咯作响，但很快就结束了。你命令手下收集粮草，准备运回给%commander%。 | 农民和他们雇佣的伏击队已经被杀个干净。你命令手下收集粮草。%commander%和他的士兵应该会很高兴看到你回来。 | 食物上有一些血迹，但是用一点水就能擦掉。%commander%的士兵会感谢你所做的。 | %randombrother%找到一个装死的农民，割破了他的喉咙。那人咳嗽着，扭动着从佣兵的手中挣脱出来。他跑到一个货车上，血洒得粮食上到处都是。你大声喊道。%SPEECH_ON%该死，把他弄下去！%SPEECH_OFF%这个农民很快就被处置了，但货物毫无疑问已经毁了。你摇了摇头。%SPEECH_ON%给那些东西盖上一块毯子。或许没人会注意到。%SPEECH_OFF% | 取得食物比预期的麻烦了一些，但现在一切都在你的掌握中。你把农田的所有权交给了一个穿着羊皮鞋的贫穷农工。%SPEECH_ON%记住你主人的下场，因为这肯定也会发生在你身上，知道了吗？%SPEECH_OFF%孩子迅速点了点头。你命令%companyname%准备返回，向%commander%复命。}",
			Image = "",
			List = [],
			Options = [
				{
		...
		this.m.Screens.push({
			...
			Title = "在战营…",
			Text = "[img]gfx/ui/events/event_96.png[/img]你到会战指挥官%commander%的帐篷里见他。他看起来相当兴奋。一个机敏而神秘的男子站在他身边。指挥官匆忙地说道。%SPEECH_ON%{据我手下的探子报告，%feudfamily%打算给他们的军队运来一批装备。如果我们能截住这批装备，他们就只能仓促上阵！ | 你好，雇佣兵。我的间谍告诉我%feudfamily%正把一件非常重要的装备运往他们的营地。我需要你前去摧毁它。 | 有什么能比间谍还棒？看看这个小家伙，他跟我说，先生，%feudfamily%会送来大量物资。武器、盔甲、食品之类的。我说，我有个最合适的人选：你！去找到这批货物并摧毁它。 | 你知道，战斗的胜负往往决定在开始之前，对吧？我的小间谍告诉我%feudfamily%有一批武器和盔甲正在来这儿的路上。如果你能成功摧毁它，那么他们的军队面对开阔地作战将毫无准备。 | 你知道吗？我曾经不挥一剑就赢得了一场战斗。我设法拦截了一批物资，导致我的敌人完全没有办法做好准备，所以他们选择了投降。我这位小间谍告诉我%feudfamily%也有同样一批装备运来。虽然它不能结束战争，但是如果你去摧毁这批装备，将会对我们产生巨大的帮助。 | 你知道吗，一支没有装备的军队根本称不上军队。%feudfamily%家族的军队物资短缺。一批武器装备正在运来的路上，这就是他们为什么还没发起攻击！不过，我的小间谍已经发现了那批货物。我希望你去摧毁它。 | 我有个极好的消息要告诉你，佣兵。%feudfamily%正在等待武器和盔甲的到来——而我们确切地知道它们从哪来。我需要你去做一件显而易见的事：摧毁那批物资，在敌人还没反应过来之前重创他。}%SPEECH_OFF%",
			Image = "",
			List = [],
			Options = [
				{
