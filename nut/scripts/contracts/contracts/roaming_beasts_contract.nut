		...
		this.m.States.push({
			...
			function end()
			{
				...
				else if (this.Flags.get("IsSpiders"))
				{
					...
					this.Const.World.Common.addFootprintsFromTo(this.Contract.m.Home.getTile(), party.getTile(), this.Const.BeastFootprints, this.Const.World.FootprintsType.Spiders, 0.750000);
				}
				else
				{
