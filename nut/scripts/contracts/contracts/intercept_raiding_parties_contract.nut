		...
		this.m.States.push({
			...
			function end()
			{
				...
				for( local i = 0; i < g; i = ++i )
				{
					...
					{
						party = cityState.spawnEntity(tile, "团" + cityState.getNameOnly(), true, this.Const.World.Spawn.Southern, this.Math.rand(100, 130) * this.Contract.getDifficultyMult() * this.Contract.getScaledDifficultyMult());
