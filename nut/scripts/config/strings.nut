...
gt.Const.Strings.PerkDescription <- {
	...
	Fearsome = "打得他们四散奔逃！任何攻击，只要造成了至少1点伤害，就会触发对手的士气检查，并施以[color=" + this.Const.UI.Color.NegativeValue + "]你的决心*15%[/color]的士气惩罚，而非仅在造成15点或以上伤害时进行无惩罚的士气检查。",
	...
	Recover = "解锁‘恢复’技能，允许角色休息一整个回合，以减少累积疲劳值的[color=" + this.Const.UI.Color.NegativeValue + "]50%[/color].",
	...
	ReachAdvantage = "学会利用大型武器的长度优势，防止敌人近身，进行有效打击。\n\n每次使用双手近战武器攻击都会使你的近战防御增加[color=" + this.Const.UI.Color.PositiveValue + "]+5[/color]，最多叠加5层，效果持续到该角色的下个回合。一次攻击多个目标可以叠加多层。收起武器会失去所有加成。",
