...
gt.Const.Strings.PerkDescription <- {
	...
	CoupDeGrace = "对已遭受创伤效果（例如手臂骨折）的目标造成的伤害额外提高[color=" + this.Const.UI.Color.PositiveValue + "]20%[/color]。",
	SteelBrow = "命中该角色头部不再造成暴击伤害，因此显著降低了遭受严重头部创伤的风险。",
	...
	FortifiedMind = "钢铁般的意志不会轻易偏离正道。决心增加[color=" + this.Const.UI.Color.PositiveValue + "]25%[/color].",
