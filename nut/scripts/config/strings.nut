...
gt.Const.Strings.PerkDescription <- {
	...
	ReachAdvantage = "学会利用大型武器的长度优势，防止敌人近身，进行有效打击。\n\n每次使用双手近战武器攻击都会使你的近战防御增加[color=" + this.Const.UI.Color.PositiveValue + "]+5[/color]，最多叠加5层，效果持续到该角色的下个回合。一次攻击多个目标可以叠加多层。\n\n收起武器会失去所有加成。",
	Overwhelm = "利用你的高主动，用攻击压制敌人的攻击！\n\n无论命中与否，每次攻击都会对本轮中后行动的敌人造成“被压制”效果。使其近战技能和远程技能都降低[color=" + this.Const.UI.Color.NegativeValue + "]10%[/color]。\n\n该效果在每次攻击中都会叠加，且可以通过一次攻击同时施加给多个目标。",
