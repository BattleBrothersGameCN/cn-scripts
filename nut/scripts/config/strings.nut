...
gt.Const.Strings.PerkDescription <- {
	Relentless = "别减速! 在任何时候，你的主动值都只减少累积疲劳值的[color=" + this.Const.UI.Color.NegativeValue + "]50%[/color]，而不是通常的100%。此外，使用“等待”指令将不再使你在下一回合受到主动值惩罚。",
	...
	Fearsome = "打得他们四散而逃！任何攻击，只要造成了至少1点伤害，就会触发对手的士气检查，并施以[color=" + this.Const.UI.Color.NegativeValue + "]你的决心*20%-10[/color]的士气惩罚，而非仅在造成15点或以上伤害时进行无惩罚的士气检查。",
	HeadHunter = "照头打！击中目标头部将使确保下次攻击时也能击中头部。效果会在下次命中后重置。",
	...
	Nimble = "轻甲专精！通过灵活地闪避和偏斜，避免受到直击。减少所受伤害，最多减少[color=" + this.Const.UI.Color.PositiveValue + "]60%[/color]，当盔甲和头盔的疲劳值上限减益超过[color=" + this.Const.UI.Color.PositiveValue + "]15[/color]点时，技能效果开始迅速下降。盔甲和头盔越轻，收益越多。\n\n“强壮”不影响该特性。\n\n不影响精神攻击和状态效果的伤害，但可以帮助避免受到它们。",
	BattleForged = "重甲专精！受到的护甲伤害减少，减少的百分比等于盔甲和头盔实时总护甲值之和的[color=" + this.Const.UI.Color.PositiveValue + "]5%[/color]。你的盔甲和头盔越重，增益越高。\n\n不影响精神攻击和状态效果的伤害，但可以帮助避免受到它们。",
	Duelist = "人兵合一，直取空门！如果副手未持有武器或者携带着可投掷的工具(如投掷网)，则可额外造成[color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color]的穿甲伤害。不适用于双手武器。",
	CripplingStrikes = "致残你的敌人！近战、远程攻击造成创伤的阈值降低[color=" + this.Const.UI.Color.NegativeValue + "]33%[/color]。",
	QuickHands = "在找这个吗？战斗中，每回合第一次替换物品视为免费动作，不需要行动点数，盾牌除外。",
	Bullseye = "射得好！当瞄准弹道受阻的目标时，受到的命中惩罚从[color=" + this.Const.UI.Color.NegativeValue + "]75%[/color]减少到[color=" + this.Const.UI.Color.NegativeValue + "]50%[/color]。",
	Ballistics = "命中率的距离惩罚每格减少[color=" + this.Const.UI.Color.NegativeValue + "]-1[/color]",
	Berserk = "哇啊啊啊啊！每回合第一次击杀敌人，立即恢复[color=" + this.Const.UI.Color.PositiveValue + "]4[/color]行动点数。角色恢复的行动点数不能超过其行动点数上限，一次攻击击杀多名敌人也只恢复4行动点数。",
	...
	KillingFrenzy = "杀戮时间到！获得击杀后，增加所有伤害的[color=" + this.Const.UI.Color.PositiveValue + "]25%[/color]。持续 2 回合。再次击杀不会叠加效果，而是会刷新计时器。",
	...
	LoneWolf = "我最好单独行动。如果3格范围内没有队友，获得[color=" + this.Const.UI.Color.PositiveValue + "]15%[/color]的近战技能、远程技能、近战防御、远程防御和决心的加成。",
