...
if (!("Wildmen" in gt.Const.DLC) || !this.Const.DLC.Wildmen)
{
	...
	if (this.Const.DLC.Wildmen)
	{
		...
		local tips = [
			...
			"当有敌人接邻时，驯兽师无法用鞭子指挥他们的战争野兽。",
			"蛮族人期望在来世与他们的祖先相遇。",
			"根据游戏风格选择不同起源，定制你的战役。",
			"在“独狼”起源游戏中，你将拥有一个玩家角色参与战斗。如果你死了，战役就结束了。",
			"在“农民民兵”起源游戏中，你可以将至多16人投入同一场战斗。",
			"游玩“邪教徒”起源时，你的神会向你索要贡品，但也会赐予忠于祂的人恩惠。",
			"游玩“偷猎团”起源时，你的队伍能更快地在世界地图上移动。",
			"游玩“贸易商队”起源时，你能获得更好的买入和卖出价格。",
			"投石索命中头部会施加“茫然”状态效果。",
			"石头遍地都是，投石索永远不缺弹药。",
			"战鞭能够暂时解除对手的武器，阻止他们使用武器技能。",
			"战鞭能够造成流血伤口，但对抗护甲效果孱弱。",
