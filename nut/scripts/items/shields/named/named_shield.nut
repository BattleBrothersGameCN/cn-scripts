this.named_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function randomizeValues()
	{
		...
		{
			_i.m.MeleeDefense = this.Math.round(_i.m.MeleeDefense * this.Math.rand(120, 140) * 0.010000);
		});
		available.push(function ( _i )
		{
			_i.m.RangedDefense = this.Math.round(_i.m.RangedDefense * this.Math.rand(120, 140) * 0.010000);
		});
		available.push(function ( _i )
		{
		...
		available.push(function ( _i )
		{
			_i.m.Condition = this.Math.round(_i.m.Condition * this.Math.rand(120, 160) * 0.010000) * 1.000000;
			_i.m.ConditionMax = _i.m.Condition;
		});
		available.push(function ( _i )
		{
			_i.m.StaminaModifier = this.Math.round(_i.m.StaminaModifier * this.Math.rand(70, 90) * 0.010000);
		});
