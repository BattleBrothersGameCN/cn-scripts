this.fangshire <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "夏尔之牙";
		this.m.Description = "夏尔之牙是一个北方老虎的头骨，它的两颗凶猛牙齿深深地镶嵌在佩戴者的面孔上，显得阴森恐怖。最初是北方掠夺者野兽比约兰戴着它，在他进行血腥袭击并烧毁海岸线上的许多村庄时，它向敌人的内心灌输了恐惧。当比约兰最终被杀后，夏尔之牙被作为战利品并向南方更远的地方流传。传言称，戴上它的人的眼睛会发出锐利的黄光，让他们能看穿整个黑暗的夜晚。";
