...
::Reforged.QueueBucket.Late.push(function ()
{
	::Reforged.HooksMod.hook("scripts/ambitions/ambition", function ( q )
	{
		q.getButtonTooltip = function ( __original )
		{
			return {
				function getButtonTooltip()
				{
					...
					if (this.getRenownOnSuccess() != 0)
					{
						ret.push({
							...
							text = ::Reforged.Mod.Tooltips.parseString(::MSU.Text.colorizeValue(this.getRenownOnSuccess(), {
								AddSign = true
							}) + "[名望|Concept.BusinessReputation]")
						});
					}
