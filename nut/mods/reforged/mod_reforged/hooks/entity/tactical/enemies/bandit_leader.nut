				...
				if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Mainhand))
				{
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Offhand))
					{
						local weapon = ::MSU.Class.WeightedContainer([
							...
							[
								1,
								"scripts/items/weapons/rf_swordstaff"
							]
						]).roll();
				...
				if (this.m.IsMiniboss)
				{
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Body))
					{
						this.m.Items.equip(::new(::MSU.Class.WeightedContainer([
							...
							[
								1,
								"scripts/items/armor/sellsword_armor"
							]
						]).roll()));
					}
					...
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Head))
					{
						this.m.Items.equip(::new(::MSU.Class.WeightedContainer([
							...
							[
								1,
								"scripts/items/helmets/rf_half_closed_sallet"
							],
							[
								1,
								"scripts/items/helmets/rf_conical_billed_helmet"
							],
							[
								1,
								"scripts/items/helmets/rf_sallet_helmet_with_mail"
							],
							[
								1,
								"scripts/items/helmets/rf_padded_conical_billed_helmet"
							]
						]).roll()));
					}
				}
					...
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Body))
					{
						local armor = ::Reforged.ItemTable.BanditArmorLeader.roll({
							function Apply( _script, _weight )
							{
								...
								if (conditionMax < 210 || conditionMax > 240)
								{
									return 0.0;
								}
					...
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Head))
					{
						local helmet = ::Reforged.ItemTable.BanditHelmetLeader.roll({
							function Apply( _script, _weight )
							{
								...
								if (conditionMax < 180 || conditionMax > 230)
								{
									return 0.0;
								}
				...
				else if (r <= 75)
				{
					local armor = ::Reforged.ItemTable.NamedArmorNorthern.roll({
						function Apply( _script, _weight )
						{
							...
							if (conditionMax < 210 || conditionMax > 260)
							{
								return 0.0;
							}
				...
				else
				{
					local helmet = ::Reforged.ItemTable.NamedHelmetNorthern.roll({
						function Apply( _script, _weight )
						{
							...
							if (conditionMax < 210 || conditionMax > 265)
							{
								return 0.0;
							}
