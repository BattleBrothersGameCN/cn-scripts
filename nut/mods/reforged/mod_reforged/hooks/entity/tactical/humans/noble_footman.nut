			...
			function assignRandomEquipment()
			{
				...
				if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Offhand))
				{
					local shield = ::new(::MSU.Class.WeightedContainer([
						[
							1,
							"scripts/items/shields/faction_kite_shield"
						],
						[
							1,
							"scripts/items/shields/faction_heater_shield"
						]
					]).roll());
				...
				if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Body))
				{
					local script = ::MSU.Class.WeightedContainer([
						...
						[
							1,
							"scripts/items/armor/basic_mail_shirt"
						]
					]).roll();
					...
					if (::Math.rand(1, 100) <= ::Reforged.Config.ArmorAttachmentChance.Tier2)
					{
						local armorAttachment = ::Reforged.ItemTable.ArmorAttachmentNorthern.roll({
							function Apply( _script, _weight )
							{
								...
								if (conditionModifier < 20 || conditionModifier > 30)
								{
									return 0.0;
								}
				...
				if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Head))
				{
					...
					if (banner <= 4)
					{
						helmet = ::new(::MSU.Class.WeightedContainer([
							...
							[
								1,
								"scripts/items/helmets/padded_kettle_hat"
							],
							[
								1,
								"scripts/items/helmets/rf_skull_cap"
							],
							[
								1,
								"scripts/items/helmets/rf_skull_cap_with_rondels"
							],
							[
								1,
								"scripts/items/helmets/rf_padded_skull_cap"
							],
							[
								1,
								"scripts/items/helmets/rf_padded_skull_cap_with_rondels"
							]
						]).roll());
					}
					else if (banner <= 7)
					{
						helmet = ::new(::MSU.Class.WeightedContainer([
							...
							[
								1,
								"scripts/items/helmets/padded_flat_top_helmet"
							],
							[
								1,
								"scripts/items/helmets/rf_skull_cap"
					...
					else
					{
						helmet = ::new(::MSU.Class.WeightedContainer([
							...
							[
								1,
								"scripts/items/helmets/padded_nasal_helmet"
							],
							[
								1,
								"scripts/items/helmets/rf_skull_cap"
