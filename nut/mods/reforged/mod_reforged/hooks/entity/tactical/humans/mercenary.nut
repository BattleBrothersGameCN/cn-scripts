			...
			function assignRandomEquipment()
			{
				...
				if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Body))
				{
					local armor = ::MSU.Class.WeightedContainer([
						...
						[
							1,
							"scripts/items/armor/padded_leather"
						],
						[
							1,
						...
						[
							1,
							"scripts/items/armor/light_scale_armor"
						],
						[
							1,
				...
				if (this.getBodyItem() != null && ::Math.rand(1, 100) <= ::Reforged.Config.ArmorAttachmentChance.Tier4)
				{
					...
					if (armorAttachment != null)
					{
					  ...
					  // [331]  OP_CLOSE          0      1    0    0
				}

				if ($[stack offset 0].m.Items.hasEmptySlot(::Const.ItemSlot.Head) && ::Math.rand(1, 100) <= 95)
				{
					...
					$[stack offset 0].m.Items.equip(::new(helmets.roll()));
				}
			}
