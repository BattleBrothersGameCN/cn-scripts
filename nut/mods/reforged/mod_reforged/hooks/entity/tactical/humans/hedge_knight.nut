				...
				if (this.m.IsMiniboss)
				{
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Body))
					{
						this.m.Items.equip(::new(::MSU.Class.WeightedContainer([
							[
								1,
								"scripts/items/armor/rf_breastplate_armor"
							],
							[
								1,
								"scripts/items/armor/rf_breastplate_harness"
							]
						]).roll()));
					}
					...
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Head))
					{
						this.m.Items.equip(::new(::MSU.Class.WeightedContainer([
							[
								1,
								"scripts/items/helmets/rf_half_closed_sallet_with_mail"
							],
							[
								1,
								"scripts/items/helmets/rf_visored_bascinet"
							],
							[
								1,
								"scripts/items/helmets/rf_half_closed_sallet_with_bevor"
							]
						]).roll()));
					}
				}
				else
				{
					...
					if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Head))
					{
						this.m.Items.equip(::new(::MSU.Class.WeightedContainer([
							[
								1,
								"scripts/items/helmets/closed_flat_top_with_mail"
							],
							[
								0.5,
								"scripts/items/helmets/conic_helmet_with_faceguard"
							],
							[
								1,
			...
			function makeMiniboss()
			{
				...
				if (r == 1)
				{
					local weapon = ::MSU.Class.WeightedContainer([
						...
						[
							1,
							"scripts/items/weapons/named/named_rf_poleaxe"
						],
						[
							1,
