::DynamicPerks.Perks.addPerks([
	...
	},
	{
		...
		Icon = "ui/perks/perk_devastating_strikes.png",
		IconDisabled = "ui/perks/perk_devastating_strikes_sw.png"
	},
	{
		ID = "perk.stalwart",
		...
		Icon = "ui/perks/perk_stalwart.png",
		IconDisabled = "ui/perks/perk_stalwart_sw.png"
	},
	{
		...
		function verifyPrerequisites( _player, _tooltip )
		{
			...
			if (poison != null)
			{
				_tooltip.push({
					...
					type = "hint",
					icon = "ui/icons/icon_locked.png",
					text = ::Reforged.Mod.Tooltips.parseString("特技被锁定，与" + ::Reforged.NestedTooltips.getNestedPerkName(poison) + "特技互斥")
				});
				return false;
			}
...
::Const.Perks.findById("perk.nimble").verifyPrerequisites <- {
	function verifyPrerequisites( _player, _tooltip )
	{
...
::Const.Perks.findById("perk.battle_forged").verifyPrerequisites <- {
	function verifyPrerequisites( _player, _tooltip )
	{
		local poison = _player.getSkills().getSkillByID("perk.rf_poise");
