					...
					DynamicDefs = {
						UnitBlocks = [
							...
							},
							{
								...
								RatioMax = 0.11,
								PartySizeMin = 20,
								StartingResourceMin = 214
							},
							{
								BaseID = "UnitBlock.RF.SkeletonSupport",
								RatioMax = 0.12,
								StartingResourceMin = 295,
								PartySizeMin = 12,
								HardMax = 2,
								ExclusionChance = 40
							},
				...
				},
				{
					...
					DynamicDefs = {
						UnitBlocks = [
							...
							{
								BaseID = "UnitBlock.RF.NecromancerUpgrade",
								RatioMax = 0.18,
								StartingResourceMin = 215,
								ExclusionChance = 50
							},
							{
								BaseID = "UnitBlock.RF.GhoulMedium",
								RatioMax = 0.2,
								StartingResourceMin = 340,
								ExclusionChance = 33
							},
							{
