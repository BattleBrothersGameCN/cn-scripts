local parties = [
	{
		...
		DynamicDefs = {
			UnitBlocks = [
				{
					BaseID = "UnitBlock.RF.BarbarianFrontline",
					RatioMin = 0.6,
					RatioMax = 1.0
				},
				{
					BaseID = "UnitBlock.RF.BarbarianSupport",
					HardMax = 2,
					RatioMax = 0.15,
					PartySizeMin = 10
				},
				{
					BaseID = "UnitBlock.RF.BarbarianDog",
					RatioMax = 0.4,
					PartySizeMin = 5,
					ExclusionChance = 70
				},
	...
	},
	{
		...
		DynamicDefs = {
			UnitBlocks = [
				{
					BaseID = "UnitBlock.RF.BarbarianHunterFrontline",
					RatioMin = 0.6,
					RatioMax = 1.0
				},
				{
