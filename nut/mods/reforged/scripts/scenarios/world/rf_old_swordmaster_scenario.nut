this.rf_old_swordmaster_scenario <- ::inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Name = "重铸 - 老剑师";
		this.m.Description = "[p=c][img]gfx/ui/events/event_17.png[/img][/p][p]你是一名传奇剑术大师，渴望把自己的技艺传下去！" + ::MSU.Text.colorNegative("详细阅读导入事件，了解起源运作机制！") + "\n\n[color=#bcad8c]传道授业：[/color]学徒升级时，有几率获得一个免费的剑特技。\n[color=#bcad8c]非剑不用：[/color]你的战团不能使用除剑以外的其他武器，远程武器和旗帜除外。使用剑时有特殊加成。\n[color=#bcad8c]精挑细选：[/color]最多拥有" + this.m.BrothersMax + "名角色，上场" + this.m.BrothersMaxInCombat + "名角色。\n[color=#bcad8c]新鲜血液：[/color]无法雇佣高度专精近战的背景。\n[color=#bcad8c]一路艰辛：[/color]从前期难度就开始大幅上升，提供的工作也会更难。\n[color=#bcad8c]化身：[/color]如果你的剑术大师死了，战役就结束了。[/p]";
		this.m.Difficulty = 3;
		this.m.Order = 1;
