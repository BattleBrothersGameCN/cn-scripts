this.rf_random_solo <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Name = "重铸 - 随机单人";
		this.m.Description = "[p=c][img]gfx/ui/events/rf_random_solo_intro.png[/img][/p][p]以随机的开始进入世界。\n\n[color=#bcad8c]随机开始：[/color]以一名随机角色开始游戏。\n[color=#bcad8c]化身：[/color]如果你的初始角色死了，战役就结束了。\n[color=#bcad8c]天赋异禀：[/color]初始角色等级为4，天赋等级都是3星。[/p]";
		this.m.Difficulty = 3;
		this.m.Order = 1;
	}
