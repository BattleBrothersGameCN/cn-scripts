this.rf_onslaught_skill <- ::inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "冲击阵线";
		this.m.Description = "命令你的人向前推进，突破敌人阵线！";
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = ::Reforged.Mod.Tooltips.parseString("你和" + ::MSU.Text.colorPositive(this.m.AllyDistanceMax) + "格内的友军获得[$ $|Skill+rf_onslaught_effect]效果，持续2[轮|Concept.Round]")
		});
		ret.push({
			id = 20,
			type = "text",
