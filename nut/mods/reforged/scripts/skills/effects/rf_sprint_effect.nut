	...
	function getTooltip()
	{
		...
		if (this.m.FatigueMult != 1.0)
		{
			ret.push({
				...
				text = ::Reforged.Mod.Tooltips.parseString(::MSU.Text.colorizeMultWithText(this.m.FatigueMult, {
					InvertColor = true
				}) + " [Fatigue|Concept.Fatigue] built per tile traveled")
			});
		}
